...
* [GitHub Repo](https://github.com/nestjs/nest) ⭐ 76,692 | 🐛 24 | 🌐 TypeScript | 📅 2026-09-21
...
* Examples
  * [Nest Starter](https://github.com/nestjs/typescript-starter) ⭐ 2,148 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - Nest framework TypeScript starter.
...
* [NestJs Authentication](https://github.com/anilahir/nestjs-authentication-and-authorization) ⭐ 291 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - NestJS Authentication without Passport using Bcrypt, JWT and Redis
...
* [Hoppscotch](https://github.com/hoppscotch/hoppscotch) ⭐ 80,439 | 🐛 825 | 🌐 TypeScript | 📅 2026-09-21 - Open source API development ecosystem with NestJS backend - alternative to Postman.
* [Twenty](https://github.com/twentyhq/twenty) ⭐ 57,203 | 🐛 197 | 🌐 TypeScript | 📅 2026-09-21 - An open-source full-stack CRM system designed as an alternative to Salesforce for managing customer data and workflows efficiently.
* [ToolJet](https://tooljet.io/) - ToolJet is the open-source low-code framework alternative to Retool & Mendix to build & deploy internal tools with minimal engineering effort. ([Source Code](https://github.com/ToolJet/ToolJet) ⭐ 40,950 | 🐛 1,231 | 🌐 JavaScript | 📅 2026-09-21) `GPL-3.0`
* [Novu](https://github.com/novuhq/novu) ⭐ 40,023 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-21 - The open-source notification infrastructure with fully functional embedded notification center.
...
* [apitable](https://github.com/apitable/apitable) ⭐ 15,612 | 🐛 307 | 🌐 TypeScript | 📅 2026-09-06 - APITable, an API-oriented low-code platform for building collaborative apps and better than all other Airtable open-source alternatives.
* [Ghostfolio](https://github.com/ghostfolio/ghostfolio) ⭐ 9,327 | 🐛 323 | 🌐 TypeScript | 📅 2026-09-21 - Ghostfolio is a privacy-focused, open-source dashboard that simplifies asset tracking and supports informed financial decisions.
* [Vendure](https://github.com/vendure-ecommerce/vendure) ⭐ 8,461 | 🐛 225 | 🌐 TypeScript | 📅 2026-09-21 - Open-Source headless GraphQL ecommerce framework built on NestJS, with a focus on developer productivity and ease of customization.
* [Gauzy](https://github.com/ever-co/gauzy) ⭐ 7,823 | 🐛 458 | 🌐 TypeScript | 📅 2026-09-21 - Open-Source Profits Sharing Platform for modern agencies and studios.
* [Manifest](https://manifest.build) - Open-source real-time cost observability for AI agents. Built with NestJS 11, TypeORM, SQLite. Tracks tokens, costs, messages, model usage. Self-hostable, privacy-focused, OTLP-native. ([Source Code](https://github.com/mnfst/manifest) ⭐ 7,539 | 🐛 110 | 🌐 TypeScript | 📅 2026-09-21) `MIT`
...
* [Necord/Toolkit](https://github.com/necordjs/toolkit) ⭐ 25 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-20 - Toolkit is an open-source bot for searching and sending documentation, built with Necord.
...
* ![](https://img.shields.io/github/stars/samchon/typia.svg?style=flat-square) [`typia`](https://github.com/samchon/typia) ⭐ 5,911 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-21: 20,000x times faster runtime validator using pure TypeScript type.
...
* [`@nestjs/cqrs`](https://github.com/nestjs/cqrs) ⭐ 941 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21 - A lightweight CQRS module for Nest framework.
* [`@nestjs/throttler`](https://github.com/nestjs/throttler) ⭐ 706 | 🐛 46 | 🌐 TypeScript | 📅 2026-09-21 - A rate limiting module for NestJS with multiple storage strategies.
* ![](https://img.shields.io/github/stars/nestjsx/nestjs-config.svg?style=flat-square) [`nestjs-config`](https://github.com/nestjsx/nestjs-config) ⭐ 704 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-21 - A Great module to handle project configurations.
...
* [`@nestjs/cache-manager`](https://github.com/nestjs/cache-manager) ⭐ 168 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-21 - Official caching module for NestJS with support for multiple stores (Redis, Memcached, etc.).
...
* [`@nestjs/swagger`](https://github.com/nestjs/swagger) ⭐ 1,893 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-21 - This's an OpenAPI (Swagger) module for Nest. *\[[Tutorial](https://docs.nestjs.com/recipes/swagger)]*.
...
* ![](https://img.shields.io/github/stars/ofri-peretz/eslint.svg?style=flat-square) [`eslint-plugin-nestjs-security`](https://github.com/ofri-peretz/eslint/tree/main/packages/eslint-plugin-nestjs-security) ⭐ 19 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-21 - Security-focused ESLint rules for controllers and DTOs: missing guards, throttling and validation pipes, exposed private fields and debug endpoints.
...
* ![](https://img.shields.io/github/stars/gremo/nest-winston.svg?style=flat-square) [`nest-winston`](https://github.com/gremo/nest-winston) ⭐ 731 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-21 - Winston module for NestJS.
...
* [`@nestjs/event-emitter`](https://github.com/nestjs/event-emitter) ⭐ 251 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-21 - Official event emitter module for NestJS based on eventemitter2.
...
* ![](https://img.shields.io/github/stars/SocketSomeone/nestjs-resilience.svg?style=flat-square) [`nestjs-resilience`](https://github.com/SocketSomeone/nestjs-resilience) ⭐ 330 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - A module for improving the reliability and fault-tolerance of your NestJS applications.
...
* [`@nestjs/typeorm`](https://github.com/nestjs/typeorm) ⭐ 2,157 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21 - A TypeORM module for Nest framework \[[Tutorial](http://docs.nestjs.com/recipes/sql-typeorm)].
* [`@nestjs/mongoose`](https://github.com/nestjs/mongoose) ⭐ 572 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-21 - A Mongoose module for Nest framework.
* ![](https://img.shields.io/github/stars/mikro-orm/nestjs.svg?style=flat-square) [`@mikro-orm/nestjs`](https://github.com/mikro-orm/nestjs) ⭐ 293 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - A [MikroORM](https://mikro-orm.io/) module for Nest Framework.
* ![](https://img.shields.io/github/stars/kpfromer/nestjs-typegoose.svg?style=flat-square) [`nestjs-typegoose`](https://github.com/kpfromer/nestjs-typegoose) ⭐ 287 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-19 - A [Typegoose](https://github.com/typegoose/typegoose) ⭐ 2,311 | 🐛 18 | 🌐 TypeScript | 📅 2026-09-09 module for Nest framework.
...
* ![](https://img.shields.io/github/stars/nestjsx/nestjs-amqp.svg?style=flat-square) [`nestjs-amqp`](https://github.com/nestjsx/nestjs-amqp) ⭐ 185 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-21 - An amqp connection manager.
...
* ![](https://img.shields.io/github/stars/ForestAdmin/agent-nodejs.svg?style=flat-square) [`@forestadmin/agent`](https://github.com/ForestAdmin/agent-nodejs) ⭐ 86 | 🐛 117 | 🌐 TypeScript | 📅 2026-09-21 - NestJS compatible plugin for [Forest Admin](https://www.forestadmin.com), an off-the-shelf administration panel based on a highly-extensible API plugged into your application.

#### Scheduling

* [`@nestjs/bull`](https://github.com/nestjsx/nest-bull) ⭐ 702 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-21 - A Bull module for Nest framework.
* [`@nestjs/schedule`](https://github.com/nestjs/schedule) ⭐ 423 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-21 - Official schedule module for NestJS providing cron jobs, timeouts, and intervals.
...
* ![](https://img.shields.io/github/stars/necordjs/necord.svg?style=flat-square) [`necord`](https://github.com/necordjs/necord) ⭐ 497 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21 - A module for creating Discord bots using NestJS, based on [Discord.js](https://github.com/discordjs/discord.js) ⭐ 26,828 | 🐛 165 | 🌐 TypeScript | 📅 2026-09-21.
  * ![](https://img.shields.io/github/stars/necordjs/pagination.svg?style=flat-square) [`@necord/pagination`](https://github.com/necordjs/pagination) ⭐ 15 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - A lightweight Pagination module for [Necord](https://github.com/necordjs/necord) ⭐ 497 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21.
  * ![](https://img.shields.io/github/stars/necordjs/localization.svg?style=flat-square) [`@necord/localization`](https://github.com/necordjs/localization) ⭐ 11 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - Localize your Discord bot with [Necord](https://github.com/necordjs/necord) ⭐ 497 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-21.
...
* [`@nestjs/cli`](https://github.com/nestjs/nest-cli) ⭐ 2,197 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-21 - CLI tool for NestJS applications.
...
* ![](https://img.shields.io/github/stars/jmcdo29/nest-commander.svg?style=flat-square) [`nest-commander`](https://github.com/jmcdo29/nest-commander) ⭐ 485 | 🐛 30 | 🌐 TypeScript | 📅 2026-09-21 - A module for using NestJS to build up CLI applications
